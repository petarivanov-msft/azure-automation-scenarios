...
output "deployment_summary" {
  ...
  value       = <<-EOT
    ...
    🔗 Portal: https://portal.azure.com/#@/resource${azurerm_resource_group.rg.id}
    
    🤖 Automation Account: ${azurerm_automation_account.automation.name}
    🔗 Portal: https://portal.azure.com/#@/resource${azurerm_automation_account.automation.id}
    ...
    👥 Worker Group: ${azurerm_automation_hybrid_runbook_worker_group.worker_group.name}
    
    📜 Test Runbook: ${azurerm_automation_runbook.test_hybrid_worker.name}
    🔗 Portal: https://portal.azure.com/#@/resource${azurerm_automation_runbook.test_hybrid_worker.id}
    
    🔑 VM Credentials:
       Username: ${var.admin_username}
       Password: (run 'terraform output vm_admin_password' to view)
    
    💡 Test the Hybrid Worker:
       
       # Start the test runbook
